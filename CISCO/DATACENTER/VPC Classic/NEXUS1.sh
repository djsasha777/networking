...
vpc domain 1
  peer-gateway
  role priority 1
  peer-keepalive destination 192.169.0.2 source 192.169.0.1 vrf keepalive
...
interface Ethernet1/1
  no switchport
  ip address 172.0.4.2/24
  no shutdown

interface Ethernet1/2
  no switchport
  ip address 172.0.5.2/24
  no shutdown
...
router ospf 1
  ...
  network 172.0.4.0/24 area 0.0.0.1
